import Platformv.Main;
import Platformv.Models.BM25;
...
public class PlatformTest extends AbstractJavaSamplerClient implements Serializable {
    @Override public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        result.sampleStart();
        result.setSampleLabel("Platform Test Sample");
